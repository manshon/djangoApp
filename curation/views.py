...
def home(request):
    ...
    # return render(request, 'curation/home.html',
    #               {'community': community,
    #                'articles': articles})
    return HttpResponseRedirect(reverse('curation:real_home',args=(community_id,)))
...
def article_detail(request,community_id, article_id):
    ...
    comments = article.comment.order_by('-created_at')
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(reverse('curation:article_detail', args=(community_id, article_id,)))
    else:
        form = ArticleCommentForm()
        return render(request, 'curation/article_detail.html',
                  {'article': article,
                   'form': form,
                   'comments': comments,
...
def article_create(request, community_id):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'curation/article_create.html',
                      {'form': form,
                       'community_id': community_id})
...
def article_edit(request, community_id, article_id):
    ...
    if article.admin_id != request.user.id:
        error = '権限がありません'
        return render(request, 'curation/error.html',
                      {'error': error})
    ...
    if request.method == 'POST':
        ...
        return render(request, 'curation/article_edit.html',
                      {'form': form,
                       'article': article})
...
def my_article(request):
    ...
    return render(request, 'curation/my_article.html',
                  {'articles': articles,
                   'is_exists': is_exists})
...
def article_delete(request, article_id):
    article = get_object_or_404(Article, id=article_id)
    article.delete()
    return HttpResponseRedirect(reverse('curation:real_home',args=(article.community_id,)))
...
def comment_delete(request, article_id, comment_id):
    ...
    article = get_object_or_404(Article, id=article_id)
    comment.delete()
    return HttpResponseRedirect(reverse('curation:article_detail', args=(article.community_id, article_id,)))
...
def community_manage(request):
    ...
    return render(request, 'curation/community_manage.html',
...
def community_create(request):
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(reverse('curation:community_manage'))
    else:
        form = CommunityCreateForm()
        return render(request, 'curation/community_create.html',
                      {'form': form})
...
def community_detail(request, community_id):
    ...
    return render(request, 'curation/community_detail.html',
                  {'community': community,
...
def community_edit(request, community_id):
    ...
    if request.method == 'POST':
        ...
        return HttpResponseRedirect(reverse('curation:community_detail', args=(community_id,)))
    else:
        form = CommunityEditForm(instance=community)
        return render(request, 'curation/community_edit.html',
                      {'form': form,
                       'community': community})
...
def community_search(request):
    ...
    return render(request, 'curation/community_search.html',
                  {'communities': communities})
...
def community_user_manage(request, community_id):
    ...
    if request.method == 'POST':
        ...
        if user_id:
            ...
            community.save()
        return HttpResponseRedirect(reverse('curation:community_user_manage',kwargs={'community_id': community_id}))
    else:
        return render(request, 'curation/community_user_manage.html',
...
def community_permitted_user_manage(request, community_id):
    ...
    return render(request, 'curation/community_permitted_user_manage.html',
